...
function unitMainMenuText() {
  const body = [
    "🎓 <b>راهنمای جامع انتخاب واحد دانشگاه پیام نور</b>",
    "انتخاب واحد یکی از مهم‌ترین مراحل آموزشی دانشجویان دانشگاه پیام نور است که پیش از آغاز هر نیمسال تحصیلی انجام می‌شود.",
    "<br>",
    "<b>زمان انتخاب واحد</b>",
    "دانشگاه پیام نور معمولاً در سه بازه آموزشی امکان انتخاب واحد را فعال می‌کند:",
    "🔹 <b>نیمسال اول</b> (معمولاً در اواسط شهریورماه)",
    "🔹 <b>نیمسال دوم</b> (معمولاً اواخر دی یا اوایل بهمن)",
    "🔹 <b>ترم تابستان</b> (اختیاری و با تعداد درس‌های ارائه‌شده محدودتر)",
    "بازه انتخاب واحد معمولاً حدود <b>یک هفته تا ده روز</b> است و ممکن است تمدید هم شود. پس از انتخاب واحد نیز معمولاً یک بازه برای <b>حذف و اضافه</b> در نظر گرفته می‌شود.",
    "<br>",
    "<b>سامانه انتخاب واحد پیام نور</b>",
    "تمام امور مهم آموزشی، از جمله انتخاب واحد، حذف و اضافه، پرداخت شهریه، مشاهده نمرات و دریافت گزارش‌ها، در <b>سامانه جامع گلستان</b> انجام می‌شود:",
    "📱 ورود با موبایل ممکن است، اما برای جلوگیری از خطا یا ثبت اشتباه، <b>استفاده از لپ‌تاپ یا کامپیوتر و اینترنت پایدار</b> توصیه می‌شود. همچنین، لطفاً در طول انجام این فعالیت، اتصال فیلترشکن خود را قطع نمایید.",
    "<br>",
    "<b>چک‌لیست ضروری قبل از انتخاب واحد</b>",
    "پیش از باز شدن زمان انتخاب واحد، این موارد را آماده کنید:",
    "1) <b>بررسی وضعیت مالی و پرداخت شهریه</b>",
    "معمولاً تا زمانی که <b>شهریه ثابت و بدهی‌های قبلی</b> پرداخت نشده باشد، منوی ثبت‌نام برای دانشجو فعال نمی‌شود.",
    "برای اطلاعات از جزئیات شهریه و پرداخت آن به قسمت پرداخت شهریه مراجعه کنید.",
    "",
    "2) <b>بررسی نمرات ترم قبل</b>",
    "نمرات و معدل خود را بررسی کنید، مخصوصاً اگر:",
    "• درسی را مردود شده‌اید؛",
    "• احتمال مشروطی دارید؛",
    "• درسی که می‌خواهید بردارید پیش‌نیاز دارد.",
    "",
    "3) <b>دریافت لیست ارائه دروس</b>",
    "مهم‌ترین ابزارهای شما برای انتخاب واحد، <b>آخرین لیست ارائه دروس مرکز/رشته‌تان</b> <i>(گزارش 212)</i> است که از مسیر زیر قابل مشاهده هست:",
    "<code>آموزش ← گزارش‌های آموزش ← درس‌های ترمی ← لیست دروس ارائه‌شده (ویژه دانشجو)</code>",
    "",
    "📋 <b>آماده‌کردن برنامه شخصی</b>",
    ...
    "<br>",
    "<b>مراحل انتخاب واحد در سامانه گلستان</b>",
    "1️⃣ وارد <b>سامانه گلستان</b> شوید.",
    "4️⃣ از منوی اصلی به مسیر زیر بروید:",
    "<code>ثبت‌نام ← عملیات ثبت‌نام ← ثبت‌نام اصلی</code>",
